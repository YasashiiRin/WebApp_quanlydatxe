...
class OrdersAdmin(admin.ModelAdmin):
    list_display = ('vehicle','name_customer_order','pickup_daytime','quantity_slot','name_driver_order','name_schedule_order','day_schedule','name_vehicle_order','name_carowner_order','pickup_location','dropoff_location','start_date_time','dropoff_datetime','total_price','state_book','state_order')
    search_fields = ('name_customer_order','day_schedule','name_driver_order','name_schedule_order','quantity_slot')
    class Media:
        css = {
            'all': ('CSS/custom_admin.css',),
        }
